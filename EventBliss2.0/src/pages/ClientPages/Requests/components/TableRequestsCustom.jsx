...
export function TableRequestsCustom() {
    ...
    const selectData = [ "event_name", "comment", "start_date", "ending_date", "location", "estimated_price", "organizer", "action"];

    // Define los nombres de las columnas de la tabla
    const headerCell = [ "Event Name","Comment", "Start Date", "Ending Date", "Location", "Estimated Price", "Organizer", "Actions"];
