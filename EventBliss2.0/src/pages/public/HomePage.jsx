        ...
        <div>
          <div className={`w-full flex items-center transition-all duration-1000 ease-in-out transform py-10 ${
            ...
            <div className="w-full flex justify-center">
              ...
              <label htmlFor="tab1" className={`text-[23px] text-[#3B3B3B] cursor-pointer w-full flex justify-center mx-10 ${validation ? 'border-b-[3px] border-[#FD8B11]' : 'border-b-[3px] border-gray-500'} transition-colors duration-300 hover:border-[#FD8B11]`}>Clients</label>
            </div>
            <div className="w-full flex justify-center">
              <input type="radio" id="tab2" className="sr-only" name="tab-group" checked={!validation} onChange={()=> Validation()}/>
              <label htmlFor="tab2" className={`text-[23px] text-[#3B3B3B] cursor-pointer w-full flex justify-center mx-10 ${!validation ? ' border-b-[3px] border-[#9C85A6]' : 'border-b-[3px]  border-gray-500'} transition-colors duration-500 hover:border-[#9C85A6]`}>Organizers</label>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            ...
            <div className="flex justify-center items-center flex-col text-center">
              <div className="grid grid-cols-2 xl:grid-cols-3 px-4 py-6">
                ...
                <div className="w-auto h-auto bg-[#9C85A6] text-white">
