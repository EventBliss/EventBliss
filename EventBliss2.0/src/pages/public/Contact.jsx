...
export function Contact() {
    ...
    return (
        <div className="relative">
            ...
            <div className="max-w-screen-lg mx-auto py-28 relative z-10 ">
                <div className="grid grid-cols-1 md:grid-cols-12 shadow-2xl rounded-r-lg">
                    <div className="bg-gray-800 md:col-span-4 p-10 text-white rounded-l-lg">
