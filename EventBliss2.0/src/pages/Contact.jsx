export function Contact() {
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 border shadow-2xl rounded-r-md">
            <div className="bg-gray-800 md:col-span-4 p-10 text-white rounded-l-md">
                ...
                <svg className="h-6 mr-2 text-[#FD8B11]" fill="currentColor" version="1.1"
    ...
    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x={0} y={0}
    ...
    xmlSpace="preserve">
            ...
            <form className="md:col-span-8 p-10 bg-white rounded-r-md">
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            id="grid-first-name" type="text" placeholder="Tetsuo"/>
                    </div>
                    <div className="w-full md:w-1/2 px-3">
                        ...
                        <input
                            ...
                            id="grid-last-name" type="text" placeholder="Arai"/>
                    </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-6">
