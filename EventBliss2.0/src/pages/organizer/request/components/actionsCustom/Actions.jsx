...
export function Actions({id, APIFunction, status, queryKey}) {
    ...
    <div>
        {!showNoneOption && !showFinishedoption &&(
            <div className="flex justify-evenly">
                ...
                <div>
                    <Confirm name={"Approved"} className={"grid mx-auto py-2 shadow bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold px-4 rounded-lg"}  id={id} APIFunction={APIFunction} queryKey={queryKey}></Confirm>
                </div>   
             </div>
        )}
