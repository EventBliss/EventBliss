  ...
  return (
    <div className="bg-neutral">
      {role.includes('client') && (
        <footer className="flex flex-col items-center bg-neutral text-center text-white">
      ...
      <footer className="footer bottom-0 w-full p-4 bg-black/20">
        <aside className="items-center grid-flow-col">
          ...
          <p>Copyright © 2024 - All right reserved - @EventBills</p>
        </aside>
